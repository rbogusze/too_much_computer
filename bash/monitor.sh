...
# if last reading is older than 10min ago (which is how often this script is supposed to run) then let's assume the computer is off
if [ ${LAST_READING_SEC} -gt 600 ]; then
